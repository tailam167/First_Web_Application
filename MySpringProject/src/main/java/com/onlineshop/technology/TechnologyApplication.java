package com.onlineshop.technology;
...
public class TechnologyApplication {
    ...
    /**
     * Configuration with CORS (Cross-Origin Resource Sharing)
     * Cross-Origin Resource Sharing (CORS) is an HTTP-header based mechanism that allows a server to indicate any
	 * other origins (domain, scheme, or port) than its own from which a browser should permit loading of resources.
     * It related with connection between front-end and back-end in the web application
	 *
