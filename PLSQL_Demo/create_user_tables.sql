CREATE TABLE data_group (
    ...
    ,  group_feature_code NVARCHAR2(25) NOT NULL
    ,  active NUMBER(1,0) NOT NULL
    ,  note NVARCHAR2(2000) 
    , PRIMARY KEY ( group_code )
);

alter table data_group rename column group_feature_code to feature_code;
...
alter table data_group_permission RENAME column group_id to group_permission_id; 
